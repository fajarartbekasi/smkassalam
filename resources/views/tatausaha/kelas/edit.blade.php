            ...
            <div class="card-body">
                ...
                <form action="{{route('tata-usaha.simpan-data.update.kelas', $temukanKelas->id)}}" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <input type="number" name="ruang" class="form-control" value="{{$temukanKelas->ruang}}"
                                    placeholder="ruang..." required>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <input type="number" name="kapasitas" class="form-control" value="{{$temukanKelas->kapasitas}}"
